"""Main entry point for Disaster_Management_System ."""
import sys
import os
...
class MainWindow(QMainWindow):
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Disaster_Management_System")
    ...
    def on_login_successful(self, user_data):
        ...
        self.showMaximized()
        # Update window title
        self.setWindowTitle(f"Disaster_Management_System - Welcome {user_data['username']}")
